 ...
 */
async function main() {
    console.log('script.js: Função main() iniciada');
    showLoader(true);
    ...
    console.log('script.js: Exibindo página inicial');
    showPage('inicio'); // Define a página inicial
    showLoader(false);
    console.log('script.js: Inicialização completa');
    window.scriptJsLoaded = 'complete';
